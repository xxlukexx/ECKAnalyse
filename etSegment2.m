function [dcOut, summary, segList] = etSegment2(data, cfg)
        ...
        case 'labelpairs'
            ...
            for p = 1:numPairs
                ...
                for d = 1:numData
                    ...
                    evOnset = etFilterEvents2(dcIn.Data{d}.EventBuffer,...
                        cfg.onsetlabel{p});
                    evOffset = etFilterEvents2(dcIn.Data{d}.EventBuffer,...
                        cfg.offsetlabel{p});
        ...
        case 'timepairs'
            ...
            for tp = 1:numTimePairs
                ...
                switch upper(cfg.outputtype)
                    ...
                    case 'INLINE'
                        dcIn = dcSegmentInline(dcIn, d, timeOnset,...
                            timeOffset, [], outputLabel, joblabel, task);
                end
